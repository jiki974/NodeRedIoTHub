...
var url_proxy="127.0.0.1";
var port_proxy=40579;
var username_proxy="1";
var pass_proxy="1";

var proxy = "http://"+username_proxy+":"+pass_proxy+"@"+url_proxy+":"+port_proxy;
...
Http.prototype.buildRequest = function (method, path, httpHeaders, host, x509Options, done) {
  ...
  var httpOptions = url.parse(endpoint);
